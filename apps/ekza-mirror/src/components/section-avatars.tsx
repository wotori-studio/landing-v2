...
const AVATARS: Avatar[] = [
  {
    ...
    line: "The procedural volumetric shell you wear in Mirror today.",
    src: "/img/avatar-1.jpg",
    alt: "Vessel — a translucent volumetric avatar shell from the Ekza Avatar catalog.",
    fallback:
  ...
  },
  {
    ...
    line: "Chrome drifter. Provenance and hash checked before it renders.",
    src: "/img/avatar-2.jpg",
    alt: "Nomad — a chrome-plated drifter avatar from the Ekza Stellar universe.",
    fallback:
  ...
  },
  {
    ...
    name: "Prism",
    universe: "Ekza Space",
    line: "Half reflection, half neon. Built for the seam.",
    src: "/img/avatar-3.jpg",
    alt: "Prism — a neon, mirror-faceted avatar from the Ekza Space universe.",
    fallback:
  ...
  },
  {
    ...
    name: "Ronin",
    universe: "Ekza Arena",
    line: "Arena-born, heavy silhouette. Waiting on the rig.",
    src: "/img/avatar-4.jpg",
    alt: "Ronin — a heavy-silhouette arena avatar from the Ekza Arena universe.",
    fallback:
